...
def parse_train_args(args=sys.argv[1:]):
    ...
    parser.add_argument('--val_freq', type=float, default=100, help='Frequency of validation iters')
    ...
    parser.add_argument('--data_save_frequency', type=int, default=100, help='In femtoseconds')
